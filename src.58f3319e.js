      ...
      function (require, module, exports) {
        ...
        function l() {
          ...
          if (l.bottom < 0 || l.top > window.innerHeight) {
            ...
            localStorage.setItem("rod1_max_score", c),
              ...
              (s = !1),
              a.classList.remove(a.classList[0]),
        ...
        function n(o) {
          var i = t.getBoundingClientRect(),
            l = o.keyCode;
          if (13 === l && !1 === s)
            (s = !0), a.classList.add("animate-bottom-right");
          else if (68 === l || 39 === l) {
            if (i.left === window.innerWidth - t.clientWidth - 6) return;
            var n = i.left;
            (n += 15),
              (t.style.left =
                Math.min(n, window.innerWidth - t.clientWidth - 6) + "px"),
              (e.style.left =
                Math.min(n, window.innerWidth - t.clientWidth - 6) + "px");
          } else if (65 === l || 37 === l) {
            if (0 === i.left) return;
...
//# sourceMappingURL=/csb-s90eq2/src.58f3319e.js.map
